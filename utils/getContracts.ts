...
import { BUNDLER_RPC_URL, ENTRY_POINT_ABI, WALLET_ABI, WALLET_FACTORY_ABI, WALLET_FACTORY_ADDRESS } from './constants';
...
export const getWalletContract = (address: string) => {
  return new Contract(address, WALLET_ABI, provider);
};